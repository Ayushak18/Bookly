let books = [
  ...
  books.forEach((book) => {
    ...
    div.setAttribute("class", "book text-center");
    ...
    heading.setAttribute("class", "book-heading padding");
    heading.innerText = book.title;
  
    let para = document.createElement("p");
    para.setAttribute("class", "author");
    para.innerText = book.author;
  
    let anchor = document.createElement("a");
    anchor.setAttribute("class", "buy-button");
    anchor.setAttribute("href", book.website);
    anchor.innerHTML = "Buy Now";
  
    div.append(img, heading, para, anchor);
